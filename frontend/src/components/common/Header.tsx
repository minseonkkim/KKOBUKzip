...
export default function Header(){
    return <>
    <div className="fixed top-0 left-0 w-full h-[90px] px-[180px] flex flex-row justify-between items-center shadow-md z-50 bg-[rgba(255,255,255,0.8)]">
        ...
        <div className="flex flex-row items-center">
          <div className="mr-3 font-bold text-[22px] cursor-pointer">김민선님 로그인 중</div>
          <CgProfile className="mr-5 w-[30px] h-[30px] cursor-pointer" />
          <div className="bg-[#F6CA19] hover:bg-[#DFB509] shadow-[3px_3px_0px_#DFB509] hover:shadow-[3px_3px_0px_#F6CA19] rounded-[10px] px-2 py-1.5 flex flex-row items-center cursor-pointer font-dnf-bitbit">
