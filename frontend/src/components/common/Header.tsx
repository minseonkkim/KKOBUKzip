...
export default function Header(){
    return <>
    <div className="fixed top-0 left-0 w-full h-[90px] px-[180px] flex flex-row justify-between items-center shadow-md z-50 bg-[rgba(255,255,255,0.2)]">
        ...
        <div className="flex flex-row items-center">
          ...
          <div className="bg-[#F6CA19] hover:bg-[#DFB509] shadow-[3px_3px_0px_#DFB509] hover:shadow-[3px_3px_0px_#CAA612] rounded-[10px] px-2 py-1.5 flex flex-row items-center cursor-pointer font-dnf-bitbit active:scale-95">
