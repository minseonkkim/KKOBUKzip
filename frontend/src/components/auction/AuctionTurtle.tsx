...
export default function AuctionTurtle(){
    ...
    return <>
        <div onClick={goToDetail} className="bg-[#F8F9FA] shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-sm h-[330px] rounded-2xl flex flex-col cursor-pointer active:scale-95 relative">
