...
function MainPage() {
  ...
  useEffect(() => {
    // Check window height to decide if the turtle should be shown
    const handleResize = () => {
      setShowTurtle(window.innerHeight > 730);
    };
  ...
  return (
    <>
      ...
      <Header />
      <div className="relative w-full h-full min-h-screen bg-[#363636] overflow-hidden">
        <img
          src={BackgroundImg}
